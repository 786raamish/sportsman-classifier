...
def get_b64_test_image_for_babar1():
    with open("babar1.txt") as f:
        return f.read()


if __name__ == '__main__':
    load_saved_artifacts()
    # print(classify_image(get_b64_test_image_for_babar1(), None))

    print(classify_image(None, "./test_images/amir1.jpg"))
    # print(classify_image(None, "./test_images/babar.webp"))
    print(classify_image(None, "./test_images/khabib1.jpg"))
    print(classify_image(None, "./test_images/khabib2.jpg"))
    print(classify_image(None, "./test_images/roger1.jpg"))
    print(classify_image(None, "./test_images/shaheen1.png"))
